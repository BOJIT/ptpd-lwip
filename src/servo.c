 ...
 */
static inline s32_t max(s32_t a, s32_t b)
{
    return a > b ? a : b;
}
 ...
 */
static inline s32_t min(s32_t a, s32_t b)
{
    return a > b ? b : a;
}
...
static void filter(s32_t *nsec_current, filter_t *filt)
{
    s32_t s, s2;
